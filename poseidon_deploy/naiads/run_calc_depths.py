...
def process_event_folder(event_dir_path, processor, args):
    ...
    labels_folder = os.path.join(event_dir_path, args.zarr_base, args.zarr_label_dir)
    ...
    try:
        ...
        zarr_output_dir = os.path.join(event_dir_path, args.zarr_base, args.zarr_depth_dir)
